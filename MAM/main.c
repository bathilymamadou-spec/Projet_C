...
Capteur capteurs[NB_CAPTEURS] = {
    ...
    {"C01", "Pile Nord", DEFORMATION, 125.3, 120.1, 150.0, 200.0, 150.0, OK, ""},
    {"C02", "Pile Centre 1", DEFORMATION, 98.5, 95.0, 150.0, 200.0, 150.0, OK, ""},
    {"C03", "Pile Centre 2", DEFORMATION, 102.4, 100.0, 150.0, 200.0, 150.0, OK, ""},
    {"C04", "Pile Sud", DEFORMATION, 115.8, 112.0, 150.0, 200.0, 150.0, OK, ""},

    // 4 capteurs de dÉformation travées
    {"C05", "Travée Nord", DEFORMATION, 45.2, 43.0, 80.0, 200.0, 80.0, OK, ""},
    {"C06", "Travée Centre-N", DEFORMATION, 52.1, 50.0, 80.0, 200.0, 80.0, OK, ""},
    {"C07", "Travée Centre-S", DEFORMATION, 48.9, 47.0, 80.0, 200.0, 80.0, OK, ""},
    {"C08", "Travée Sud", DEFORMATION, 44.5, 42.0, 80.0, 200.0, 80.0, OK, ""},

    // 8 capteurs de vibration
    {"C09", "Noeud 1", VIBRATION, 0.42, 0.41, 0.50, 0.60, 0.425, OK, ""},
    {"C10", "Noeud 2", VIBRATION, 0.38, 0.37, 0.50, 0.60, 0.425, OK, ""},
    {"C11", "Noeud 3", VIBRATION, 0.45, 0.44, 0.50, 0.60, 0.425, OK, ""},
    {"C12", "Noeud 4", VIBRATION, 0.40, 0.39, 0.50, 0.60, 0.425, OK, ""},
    {"C13", "Noeud 5", VIBRATION, 0.51, 0.42, 0.50, 0.60, 0.425, JAUNE, "Alerte jaune"},
    {"C14", "Noeud 6", VIBRATION, 0.39, 0.38, 0.50, 0.60, 0.425, OK, ""},
